							...
							<form id="user-form" class="form-horizontal form-label-center"
								...
								<fieldset>
									...
									<div class="form-group">
										<label class="control-label col-sm-4" for="prefix">ID</label>
										<div class="col-sm-4">
									...
									<div class="form-group">
										<label class="control-label col-sm-4" for="prefix">NAME</label>
										<div class="col-sm-4">
											<input type="text" id="prefix" name="prefix"
												class="form-control input-transparent">
										</div>
									...
									<div class="form-group">
										<label class="control-label col-sm-4" for="prefix">PASSWORD</label>
										<div class="col-sm-4">
											<input type="text" id="prefix" name="prefix"
												class="form-control input-transparent">
										</div>
